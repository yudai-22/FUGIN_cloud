...
class Conv3dAutoencoder(nn.Module):
    def __init__(self):
        ...
        self.decoder = nn.Sequential(
            ...
            nn.ConvTranspose3d(32, 64, kernel_size=(4, 4, 4), stride=(2, 2, 2), padding=(0, 1, 1)), #output=(8, 56, 56)
            nn.ReLU(True),
            nn.ConvTranspose3d(64, 32, kernel_size=(3, 3, 3), stride=(1, 2, 2), padding=(0, 1, 1)), #output=(10, 111, 111)
            nn.ReLU(True),
            nn.ConvTranspose3d(32, 1, kernel_size=(3, 2, 2), stride=(1, 1, 1), padding=(0, 0, 0)), #output=(12, 112, 112)
